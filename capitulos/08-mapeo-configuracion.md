...
Cuando cerramos *Vim*, todos los ajustes realizados con ***:set*** se
...
Sin embargo, en la definición de atajos, podemos utilizar también la
...
A este comando hay que pasarle por parámetro la letra correspondiente al
